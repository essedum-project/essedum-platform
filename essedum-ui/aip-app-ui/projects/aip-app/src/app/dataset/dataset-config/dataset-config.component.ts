...
;
    ...
    // telemetryCall(){
    //   this.telemetry.startTelemetry('aip-app','DatasetConfigComponent', sessionStorage.getItem('organization'));
    // }
    ngOnInit() {
      // this.telemetryCall();
  ...
  //console.log("datasrc=", datasrc)
    ...
    openArchival() {
      ...
      //     this.services.message("Please save dataset", "Save Dataset")
      //   }
      // })
    }
    ...
    fetchTags(){
     ...
     let fetchedtags = res;
          this.tags = res;
          // console.log("value of fetchedtags is",fetchedtags);
