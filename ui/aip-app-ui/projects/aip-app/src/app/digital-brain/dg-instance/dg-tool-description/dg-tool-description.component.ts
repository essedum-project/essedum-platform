...
@Component({
  selector: 'app-dg-tool-description',
  templateUrl: './dg-tool-description.component.html',
  styleUrls: ['./dg-tool-description.component.scss'],
})
export class DgToolDescriptionComponent {
  basicReqTab: any = 'ThoughtsTab';
  tooltipPoition: string = 'above';
  addTags: string = 'Add Tags to Thoughts';
  entity: string = 'Thoughts';
  card: any;
  back: string = 'Back';
  parentType: string = 'Thoughts';
