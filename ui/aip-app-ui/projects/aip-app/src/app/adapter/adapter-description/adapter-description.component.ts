...
export class AdapterDescriptionComponent {
  ...
  ngOnInit() {
    this.service.getPermission("cip").subscribe((cipAuthority)=>{
      ...
      this.adapterServices.getAdapteByNameAndOrganization(this.route.snapshot.params.adapter).subscribe((resp) => {
        this.card = resp;
  ...
  fethchAllSpecTemplateNamesByOrg() {
    this.adapterServices.getSpecTemplateNamesByOrganization().subscribe((resp) => {
      if (resp) {
  ...
  deleteAdapter(adapterName: string) {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result === "delete") {
        this.adapterServices.deleteAdapter(adapterName).subscribe((res) => {
          if (res) {
