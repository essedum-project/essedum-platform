...
export class AdapterServices {
  ...
  getOCRDetails(formData:any): Observable<any> {
    ...
    return this.https
      .get(this.dataUrl + '/adapters/Annotation_Service/getOCRConfig/'+ this.organization, {
  ...
  CreateOCREntity(formData:any): Observable<any> {
    return this.https.post(this.dataUrl + '/adapters/Annotation_Service/CreateOcrDataset/'+this.organization, formData, {
  ...
  EditOCREntity(formData:any): Observable<any> {
    return this.https.post(this.dataUrl + '/adapters/Annotation_Service/EditOcrDataset/'+this.organization, formData, {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  TokenizeFile(formData:any): Observable<any> {
      ...
      return this.https.post(this.dataUrl + '/adapters/Annotation_Service/TokenizeFile/'+this.organization, formData, {
        headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
        observe: 'response'
      })
        .pipe(map(response => {
    ...
    TokenView(formData:any): Observable<any> {
      return this.https.post(this.dataUrl + '/adapters/Annotation_Service/TokenView/'+this.organization, formData, {
        headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
        observe: 'response'
      })
        .pipe(map(response => {
    ...
    gettaggeddata(data:any):Observable<any>{
      return this.https.post(this.dataUrl + '/adapters/Annotation_Service/TaggedData/'+this.organization, data, {
        headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
        observe: 'response'
      })
        .pipe(map(response => {
    ...
    UploadTaggedData(data:any):Observable<any>{
      return this.https.post(this.dataUrl + '/adapters/Annotation_Service/UploadtaggedData/'+this.organization, data, {
        headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
        observe: 'response'
      })
        .pipe(map(response => {
  ...
  getAdapters(org): Observable<any> {
    return this.https.get(this.dataUrl + '/mladapters/getAdaptesByOrganization/' + org, {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  createAdapter(adapter: any): Observable<any> {
    return this.https.post(this.dataUrl + '/mladapters/add', adapter, {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  updateAdapter(adapter: any): Observable<any> {
    return this.https.post(this.dataUrl + '/mladapters/update', adapter, {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  deleteAdapter(adapterName: string): Observable<any> {
    return this.https.delete(this.dataUrl + '/mladapters/delete/' + adapterName + '/' + sessionStorage.getItem("organization"), {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  fetchApiSpecTemplate(domainname, org) {
    ...
    return this.https
      .get(`${this.dataUrl}/mlspectemplates/specTemplateByDomainNameAndOrg/${domainname}/${org}`, {
        observe: 'response'
      })
      .pipe(
        map((response) => {
  ...
  callGetApi(url, parameters?, headers?) {
    ...
    return this.https.get(url, {
      observe: 'response', params: parameters, headers: headers
    })
  ...
  callPostApiFromEndpointSwagger(url, body, params?, headers?): Observable<any> {
    if (headers)
      delete headers['access-token'];
    return this.https.post(this.dataUrl+'/prompt/postPromptFromEndpoint', body, {
      headers: headers,
      params: params,
      observe: 'response'
    })
  ...
  getDataSource(connectionId: string): Observable<any> {
    return this.https.get(this.dataUrl + '/datasources/get/' + connectionId + '/' + sessionStorage.getItem("organization"), { observe: 'response' })
      .pipe(map(response => {
        return response.body;
      }))
      .pipe(catchError(err => {
  ...
  saveDataset(dataset: any): Observable<any> {
    ...
    return this.https.post(this.dataUrl + '/datasets/save/' + (dataset.id ? dataset.id : dataset.alias), dataset, { observe: 'response' })
      .pipe(switchMap(async (response) => {
        this.messageNotificaionService('success', "Done!  Method Updated Successfully");
  ...
  updateAdapterAPISpec(adapter: any): Observable<any> {
    return this.https.post(this.dataUrl + '/mladapters/updateAPISpec', adapter, {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  getAdapteByNameAndOrganization(name: string): Observable<any> {
    return this.https.get(this.dataUrl + '/mladapters/getAdapteByNameAndOrganization/' + name + '/' + sessionStorage.getItem("organization"), { observe: 'response' })
      .pipe(map(response => {
        if (response?.body['apispec']) {
          let apispec = response.body['apispec'];
          apispec = apispec.replaceAll("{org}", sessionStorage.getItem("organization"));
  ...
  getAdapterFilters(): Observable<any> {
    return this.https.get(this.dataUrl + '/mladapters/getFiltersByOrganization/' + sessionStorage.getItem("organization"), {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  getSpecTemplateFilters(): Observable<any> {
    return this.https.get(this.dataUrl + '/mlspectemplates/getFiltersByOrganization/' + sessionStorage.getItem("organization"), {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  getInstancesFilters(): Observable<any> {
    return this.https.get(this.dataUrl + '/mlinstances/getFiltersByOrganization/' + sessionStorage.getItem("organization"), {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  getAdaptersBySpectempdomainname(domainName): Observable<any> {
    return this.https.get(this.dataUrl + '/mladapters/getAdaptersBySpecTemDomNameAndOrg/' + domainName +'/' + sessionStorage.getItem("organization"), {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  getInstances(org): Observable<any> {
    return this.https.get(this.dataUrl + '/mlinstances/getMlInstanceByOrganization/' + org, {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  updateInstance(instance: any): Observable<any> {
    return this.https.post(this.dataUrl + '/mlinstances/update', instance, {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  deleteInstance(instanceName: string): Observable<any> {
    return this.https.delete(this.dataUrl + '/mlinstances/delete/' + instanceName + '/' + sessionStorage.getItem("organization"), {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  getInstanceByNameAndOrganization(name: string): Observable<any> {
    return this.https.get(this.dataUrl + '/mlinstances/getMlInstanceByNameAndOrganization/' + name + '/' + sessionStorage.getItem("organization"), { observe: 'response' })
      .pipe(map(response => {
        return response.body;
      }))
      .pipe(catchError(err => {
  ...
  getMlInstanceNamesByAdapterNameAndOrganization(adapterName: string): Observable<any> {
    return this.https.get(this.dataUrl + '/mlinstances/getMlInstanceNamesByAdapterNameAndOrganization/' + adapterName + '/' + sessionStorage.getItem("organization"), { observe: 'response' })
      .pipe(map(response => {
        return response.body;
      }))
      .pipe(catchError(err => {
  ...
  getSpecTemplateNamesByOrganization(): Observable<any> {
    return this.https.get(this.dataUrl + '/mlspectemplates/getSpecTemplateNamesByOrganization/' + sessionStorage.getItem("organization"), { observe: 'response' })
      .pipe(map(response => {
        return response.body;
      }))
      .pipe(catchError(err => {
  ...
  getMlInstanceNamesByOrganization(): Observable<any> {
    return this.https.get(this.dataUrl + '/mlinstances/getMlInstanceNamesByOrganization/' + sessionStorage.getItem("organization"), { observe: 'response' })
      .pipe(map(response => {
        return response.body;
      }))
      .pipe(catchError(err => {
  ...
  getAdapterNamesByOrganization(): Observable<any> {
    return this.https.get(this.dataUrl + '/mladapters/getAdapterNamesByOrganization/' + sessionStorage.getItem("organization"), { observe: 'response' })
      .pipe(map(response => {
        return response.body;
      }))
      .pipe(catchError(err => {
  ...
  callPostApiForMultipartFormData(url, formData: FormData, params?, headers?): Observable<any> {
    try {
      let path: string;
      if (url.startsWith('http')) {
        const urlObject = new URL(url);
      ...
      console.log("Some error occured while callPostApiForMultipartFormData API Call");
    }
  }

  uploadFileToServerForAdapterMethod(formData: FormData, adapterName: string, methodName: string): Observable<any> {
    try {
      return this.https.post('/api/aip/adapters/uploadTempFileForAdapter/' + sessionStorage.getItem("organization") + '/' + adapterName + '/' + methodName, formData, { observe: 'response' })
        .pipe(response => {
          return response;
        })
        .pipe(catchError(err => {
      ...
      console.log("Some error occured while uploadFileToServerForAdapterMethod API Call");
    }
  }

  getMethodsByInstanceAndOrganization(instanceName): Observable<any> {
    return this.https.get(this.dataUrl + '/mlinstances/getMethodsByInstanceAndOrganization/' + instanceName + '/' + sessionStorage.getItem("organization"), { observe: 'response' })
  ...
  getInstancesBySpectempdomainname(domainName): Observable<any> {
    return this.https.get(this.dataUrl + '/mlinstances/getMlInstancesBySpecTemDomNameAndOrg/' + domainName + '/' + sessionStorage.getItem("organization"), {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
  ...
  changePriorityBySpecTemDomNameAndInstancNameAndOrg(domainName, adapterInsName, priority, org): Observable<any> {
    return this.https.get(this.dataUrl + '/mlinstances/changeOrderBySpecTemDomNameAndInstancNameAndOrg/' + domainName + '/' + adapterInsName + '/' + priority + '/' + org, {
      headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }),
      observe: 'response'
    })
      .pipe(map(response => {
