...
export class EditSpecTemplateComponent implements OnInit {
  ...
  constructor(private service:AdapterServices,private route: ActivatedRoute,
  private location: Location,
  private telemetry: OpenTelemetryService,
  private router: Router){
    this.service.fetchApiSpecTemplate(this.route.snapshot.params.dname,sessionStorage.getItem("organization")).subscribe((resp:any)=>{
