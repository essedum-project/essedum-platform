...
import com.fasterxml.jackson.annotation.JsonAnyGetter;
	...
	public class JobArguments {
	    ...
	    private String jobArgumentName;

		public HashMap<String, String> getJobArgumentName() {
			HashMap<String, String> jobnamelist = this.getJobArgumentsNameList();
			return jobnamelist;
		}

		public void setJobArgumentName(String jobArgumentName) {
			this.jobArgumentName = jobArgumentName;
		}
