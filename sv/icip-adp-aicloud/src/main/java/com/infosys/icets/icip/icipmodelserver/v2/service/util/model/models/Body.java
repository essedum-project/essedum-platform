...
public class Body {
    ...
    public Body withCreatedBy(String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public Body withUpdatedBy(String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public Body withCreatedOn(String createdOn) {
        this.createdOn = createdOn;
        return this;
    }
    ...
    public Body withModifiedOn(String modifiedOn) {
        this.modifiedOn = modifiedOn;
        return this;
    }
    ...
    public Body withIsDeleted(Boolean isDeleted) {
        this.isDeleted = isDeleted;
        return this;
    }
    ...
    public Body withProjectId(String projectId) {
        this.projectId = projectId;
        return this;
    }
    ...
    public Body withPipelineId(Object pipelineId) {
        this.pipelineId = pipelineId;
        return this;
    }
    ...
    public Body withTrialId(Object trialId) {
        this.trialId = trialId;
        return this;
    }
    ...
    public Body withVersion(String version) {
        this.version = version;
        return this;
    }
    ...
    public Body withModelType(String modelType) {
        this.modelType = modelType;
        return this;
    }
    ...
    public Body withFramework(String framework) {
        this.framework = framework;
        return this;
    }
    ...
    public Body withModelFrameworkVersion(String modelFrameworkVersion) {
        this.modelFrameworkVersion = modelFrameworkVersion;
        return this;
    }
    ...
    public Body withModelArchitecture(String modelArchitecture) {
        this.modelArchitecture = modelArchitecture;
        return this;
    }
    ...
    public Body withInputMode(String inputMode) {
        this.inputMode = inputMode;
        return this;
    }
    ...
    public Body withModelDir(String modelDir) {
        this.modelDir = modelDir;
        return this;
    }
    ...
    public Body withPushToCodestore(Boolean pushToCodestore) {
        this.pushToCodestore = pushToCodestore;
        return this;
    }
    ...
    public Body withMetadata(Metadata metadata) {
        this.metadata = metadata;
        return this;
    }
